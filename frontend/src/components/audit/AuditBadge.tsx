import {
    ...
    Upload, Bell, Brain, Shield, RefreshCw,
} from 'lucide-react'
...
const config: Record<string, {
    ...
    document_status_changed: { label: 'Status Changed', color: '#0e7490', bg: '#e0f2fe', icon: <RefreshCw size={11} /> },
    ...
    ai_analysis_completed: { label: 'AI Analysis Complete', color: '#7c3aed', bg: '#ede9fe', icon: <Brain size={11} /> },
